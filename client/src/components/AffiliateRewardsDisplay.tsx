...
import { Users, DollarSign, TrendingUp, Copy, Share2, Gift } from 'lucide-react';
...
export default function AffiliateRewardsDisplay({ currentUser }: { currentUser: any }) {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-white rounded-lg border border-blue-100">
            <div className="text-2xl font-bold text-blue-600">{(totalCommissionEarned || 0).toLocaleString()}</div>
          ...
          <div className="text-center p-4 bg-white rounded-lg border border-blue-100">
            <div className="text-2xl font-bold text-orange-600">{(monthlyCommission || 0).toLocaleString()}</div>
                ...
                <TableBody>
                  {referredCustomers.map((customer) => (
                    <TableRow key={customer.id}>
                      ...
                      <TableCell>{(customer.totalPointsEarned || 0).toLocaleString()}</TableCell>
                      <TableCell className="text-green-600 font-medium">
                        {(customer.commissionEarned || 0).toLocaleString()}
                      </TableCell>
                      <TableCell>
                        <Badge 
        ...
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-lg border border-blue-100">
          <h4 className="font-semibold text-blue-800 mb-2">How Affiliate Rewards Work</h4>
