      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            KOMARCE is a unified e-commerce and loyalty ecosystem that connects customers, merchants, and administrators in a sustainable marketplace where every transaction contributes to environmental goals while earning valuable reward points.
          </p>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the innovative features that set KOMARCE apart in the e-commerce landscape
            </p>
          </div>
        ...
        {/* Stats Section */}
        <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white mb-16">
          <CardContent className="p-12">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-blue-100">Points Distributed</div>
              </div>
              <div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Join KOMARCE?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/register">
              <Button size="lg" variant="outline" className="border-2 border-purple-200 text-purple-700 hover:bg-purple-50 font-semibold px-8">
