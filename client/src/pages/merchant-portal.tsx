...
import { 
  ...
  Coins, ShoppingBag, Star, Award, QrCode, Gift, Wallet, TrendingDown, Trophy, UserPlus
} from "lucide-react";
...
// Merchant Cashback & Rewards section removed - will be rebuilt from scratch
...
export default function MerchantPortal() {
  ...
  const distributePointsMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setDistributeForm({ customerId: "", points: "", transactionType: "bonus", description: "" });
    },
    onError: (error: Error) => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-lg shadow-2xl border-0">
          <CardHeader className="text-center bg-gradient-to-r from-red-600 to-red-500 text-white rounded-t-lg">
            ...
            <p className="text-red-100">Holyloy Business Dashboard</p>
          </CardHeader>
          <CardContent className="p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  placeholder="merchant1@bd.holyloy.com"
                  className="mt-2 h-12"
                  required
            ...
            <div className="mt-6 text-center text-sm text-gray-500">
              ...
              <p>merchant1@bd.holyloy.com / merchant123</p>
              <p>merchant2@my.holyloy.com / merchant123</p>
              <p>merchant3@ae.holyloy.com / merchant123</p>
            </div>
          </CardContent>
        </Card>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="bonus">Purchase Bonus</option>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                      ...
                      <ul className="text-sm text-green-700 space-y-1">
                        <li>• Bonus: 1-15% of purchase amount</li>
